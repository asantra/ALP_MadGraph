...
#ifndef drawGridRootFiles_h
#define drawGridRootFiles_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   drawGridRootFiles(TTree *tree=0);
   virtual ~drawGridRootFiles();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(std::string mass, std::string version, std::string cutPhoton, std::string oneOverLambda);
...
#ifdef drawGridRootFiles_cxx
drawGridRootFiles::drawGridRootFiles(TTree *tree) : fChain(0) 
{
...
drawGridRootFiles::~drawGridRootFiles()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t drawGridRootFiles::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t drawGridRootFiles::LoadTree(Long64_t entry)
{
...
void drawGridRootFiles::Init(TTree *tree)
{
...
Bool_t drawGridRootFiles::Notify()
{
...
void drawGridRootFiles::Show(Long64_t entry)
{
...
Int_t drawGridRootFiles::Cut(Long64_t entry)
{
...
#endif // #ifdef drawGridRootFiles_cxx
