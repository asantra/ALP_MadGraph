...
// Thu Sep 17 14:51:30 2020 by ROOT version 6.22/00
// from TTree LHEF/Analysis tree
// found on file: unweighted_events_mass0.5GeV_beam0.6GeV_v1.root
//////////////////////////////////////////////////////////

#ifndef drawWeightedRootFiles_h
#define drawWeightedRootFiles_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   drawWeightedRootFiles(TTree *tree=0);
   virtual ~drawWeightedRootFiles();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString mass, TString version, TString cutPhoton);
...
#ifdef drawWeightedRootFiles_cxx
drawWeightedRootFiles::drawWeightedRootFiles(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Users/arkasantra/MadGraphWorks/outputRootFiles/unweighted_events_mass0.5GeV_beam2.2GeV_v1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Users/arkasantra/MadGraphWorks/outputRootFiles/unweighted_events_mass0.5GeV_beam2.2GeV_v1.root");
      }
...
drawWeightedRootFiles::~drawWeightedRootFiles()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t drawWeightedRootFiles::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t drawWeightedRootFiles::LoadTree(Long64_t entry)
{
...
void drawWeightedRootFiles::Init(TTree *tree)
{
...
Bool_t drawWeightedRootFiles::Notify()
{
...
void drawWeightedRootFiles::Show(Long64_t entry)
{
...
Int_t drawWeightedRootFiles::Cut(Long64_t entry)
{
...
#endif // #ifdef drawWeightedRootFiles_cxx
